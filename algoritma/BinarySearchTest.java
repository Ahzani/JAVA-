...
public class BinarySearchTest
{
   public static void main( String[] args )
   {
      ...
      printSearchResults( list, colors[ 3 ] ); // one item in the list
      printSearchResults( list, colors[ 0 ] ); // another item in the list
      printSearchResults( list, colors[ 7 ] ); // another item in the list
      printSearchResults( list, "aqua" ); // does not exist
